...
import {
  defaultCloudShaderHooks,
  type CloudShaderHooks
} from './ShaderHooks'
...
export interface CloudsMaterialUniforms
  ...
  referenceSampling: Uniform<number>
  referenceStepSize: Uniform<number>
  /** Alternative distant representation weight, clamped to [0, 1]. */
  farRepresentationMix: Uniform<number>
  /** Full-ray quadrature segments, clamped to [1, 128]. */
  farIterationCount: Uniform<number>

  // Backend diagnostics: 0=normal, 1=secondary optical depth, 2=composed lighting
  diagnosticMode: Uniform<number>
  diagnosticRayOrigin: Uniform<Vector3>
  diagnosticRayDirection: Uniform<Vector3>
  diagnosticRayLength: Uniform<number>
  ...
  constructor(
    {
      ...
      layerUniforms,
      atmosphereUniforms,
      shaderHooks = defaultCloudShaderHooks
    ...
    super(
      {
        ...
        uniforms: {
          ...
          referenceSampling: new Uniform(0),
          referenceStepSize: new Uniform(1),
          farRepresentationMix: new Uniform(0),
          farIterationCount: new Uniform(32),
          diagnosticMode: new Uniform(0),
          diagnosticRayOrigin: new Uniform(new Vector3()),
          diagnosticRayDirection: new Uniform(new Vector3(1, 0, 0)),
          diagnosticRayLength: new Uniform(0),
