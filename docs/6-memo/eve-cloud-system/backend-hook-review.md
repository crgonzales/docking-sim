...
| [shadow.frag](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/shaders/shadow.frag) | Change `marchClouds` to call the identical media hook and integrate bounded segments. In `cascade`, retain the paired shadow-storage encoding and finite motion-depth handling. |
| [types.glsl](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/shaders/types.glsl), [parameters.glsl](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/shaders/parameters.glsl) | Declare hook results, shared uniforms and the reference-sampling control. |
...
Add one probe-owned `CloudConformanceFixture.ts` beside the backend. Invoke it from a “Run cloud conformance” button in [RenderProbe.tsx](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/RenderProbe.tsx), gated by `probe=1&cloudSystem=eve`. Append results to the existing measurement/evidence payload.
...
The remaining bounded host edits are constructor/options plumbing in [CloudsEffect.ts](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/CloudsEffect.ts), [CloudsPass.ts](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/CloudsPass.ts), [ShadowPass.ts](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/ShadowPass.ts), [CloudsMaterial.ts](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/CloudsMaterial.ts) and [ShadowMaterial.ts](/Users/carlosgonzales/dev/docking-sim-eve-clouds/apps/web/src/scene/clouds/vendor/takram/src/ShadowMaterial.ts); the planned backend/contracts and two hook modules; probe wiring; and the vendor diff manifest. No lighting volume, far-cloud pass or additional test runner is required for this batch.
