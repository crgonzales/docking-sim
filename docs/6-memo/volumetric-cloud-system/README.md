# Volumetric cloud system implementation

Current implementation names and paths use volumetric clouds. Earlier measurements below describe their original snapshots; see [workspace cleanup](../workspace-cleanup-2026-09-14.md) for the current folder and rename map.
...
[approved plan](../../1-plans/F_0.12.0_volumetric-cloud-system.plan.md). The current far
