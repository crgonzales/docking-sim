...
First-person character development is isolated on `codex/first-person-character` in `docking-sim-character`, based on 8728d77. Its FlightMode/session integration must be reconciled with this pass before adoption; it is not silently integrated here.
