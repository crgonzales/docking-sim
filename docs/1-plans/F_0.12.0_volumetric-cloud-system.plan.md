# Volumetric cloud system implementation plan

Current project naming is volumetric clouds. EVE below identifies the third-party architectural reference. Worktree/setup instructions record the historical implementation; the active folder is now `docking-sim` (see `../6-memo/workspace-cleanup-2026-09-14.md`).

Independent plan review: **APPROVED**, 2026-09-07. [Final review](../6-memo/renderer-repair-2026-09-06/eve-plan-review-round2.txt); [initial checkpoint finding](../6-memo/renderer-repair-2026-09-06/eve-plan-review-round1.txt) is resolved below. This is architectural review, not implementation or visual acceptance.
...
- [ ] Package source/evidence for handoff; promote the selector only after acceptance. Keep failures explicit.
