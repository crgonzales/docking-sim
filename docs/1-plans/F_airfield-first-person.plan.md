...
- Integrate the reviewed first-person prototype from `/Users/carlosgonzales/dev/docking-sim-character`, preserving its worktree. Keep one camera, Canvas, composer, and live terrain source in FlightMode.
