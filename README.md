...
The public build is **v0.14.3**. The development map below also includes work
...
and separate LQR analysis have been verified in development; they are not yet
part of the public v0.14.3 release. Live MATLAB / SIL / HWIL integration and
...
Guided missions may restrict control-mode changes.
...
- **GNC Lab:** integrate the signal diagram, inspector, plots and fault controls into an accessible application mode.
